...
# command line interface(CLI) for users understanding.....
...
days_in_house2 = int(input(f'How many days did {name2} stay in the house durin the bill period ? '))
...
#jab cloud pr upload karenge to user ko pdf ka alag link mil layega
